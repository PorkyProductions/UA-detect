...
![UADetect](https://raw.githubusercontent.com/PorkyProductions/UA-detect/mega/images/png/full.png)
...
![TS](https://blog.jeremylikness.com/blog/2019-03-05_typescript-for-javascript-developers-by-refactoring-part-1-of-2/images/1.jpeg)
...
- ⏹️🏫🌳 **Objects, Classes, or Tree-Shaking** 
  -  UADetect comes with three main ways to use it. You can use the `UADetect` object, the `uaDetect` class, or import each or any of the components outlined in the [docs](/docs/index.md)
### Works On
